	...
	class WC_INVOICEBOX extends WC_Payment_Gateway
	{
		...
		**/
		public function generate_form($order_id)
		{
			...
			$itransfer_order_amount	= number_format($order->order_total, 2, '.', '');
			...
			$args = array(
				...
				"itransfer_order_currency_ident"=> $order->get_order_currency(),
				...
				"itransfer_person_name"		=> trim( $order->billing_first_name . " " . $order->billing_last_name ),
				"itransfer_person_phone"	=> trim( $order->billing_phone ),
				"itransfer_person_email"	=> trim( $order->billing_email ),
